...
public class NumberMaskTests
{
    ...
    public void ExtendNumber()
    {
        ...
        Assert.Equal("1975", string.Concat(mask.Slots.TakeWhile(c => c != default)));
    }
