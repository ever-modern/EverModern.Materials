...
namespace DestallMaterials.Svgs.Icons
{
    ...
    public static class EmojiIcons
    {
        ...
        /// emoticon icon
        /// </summary>
        public static readonly SvgIconData Emoticon = new SvgIconData(
            new string[] {
        ...
        /// emoticon-angry icon
        /// </summary>
        public static readonly SvgIconData EmoticonAngry = new SvgIconData(
            new string[] {
                "M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M7,9.5V8L10,9.5C10,10.3 9.3,11 8.5,11C7.7,11 7,10.3 7,9.5M14.77,17.23C14.32,16.5 13.25,16 12,16C10.75,16 9.68,16.5 9.23,17.23L7.81,15.81C8.71,14.72 10.25,14 12,14C13.75,14 15.29,14.72 16.19,15.81L14.77,17.23M17,9.5C17,10.3 16.3,11 15.5,11C14.7,11 14,10.3 14,9.5L17,8V9.5Z"
            },
            "0 0 24 24");

        /// <summary>
        /// emoticon-angry-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonAngryOutline = new SvgIconData(
            new string[] {
        ...
        /// <summary>
        /// emoticon-confused icon
        /// </summary>
        public static readonly SvgIconData EmoticonConfused = new SvgIconData(
            new string[] {
                "M12 2A10 10 0 1 0 22 12A10 10 0 0 0 12 2M8.5 8A1.5 1.5 0 1 1 7 9.5A1.54 1.54 0 0 1 8.5 8M17 16H13A4 4 0 0 0 9.53 18L7.8 17A6 6 0 0 1 13 14H17M15.5 11A1.5 1.5 0 1 1 17 9.5A1.54 1.54 0 0 1 15.5 11Z"
            },
            "0 0 24 24");

        /// <summary>
        /// emoticon-confused-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonConfusedOutline = new SvgIconData(
            new string[] {
                "M20 12A8 8 0 1 0 12 20A8 8 0 0 0 20 12M22 12A10 10 0 1 1 12 2A10 10 0 0 1 22 12M15.5 8A1.5 1.5 0 1 1 14 9.5A1.54 1.54 0 0 1 15.5 8M10 9.5A1.5 1.5 0 1 1 8.5 8A1.54 1.54 0 0 1 10 9.5M17 15H13A4 4 0 0 0 9.53 17L7.8 16A6 6 0 0 1 13 13H17Z"
            },
            "0 0 24 24");
        ...
        /// emoticon-dead icon
        /// </summary>
        public static readonly SvgIconData EmoticonDead = new SvgIconData(
            new string[] {
        ...
        /// <summary>
        /// emoticon-dead-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonDeadOutline = new SvgIconData(
            new string[] {
        ...
        /// emoticon-devil icon
        /// </summary>
        public static readonly SvgIconData EmoticonDevil = new SvgIconData(
            new string[] {
        ...
        /// <summary>
        /// emoticon-devil-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonDevilOutline = new SvgIconData(
            new string[] {
        ...
        /// <summary>
        /// emoticon-excited icon
        /// </summary>
        public static readonly SvgIconData EmoticonExcited = new SvgIconData(
            new string[] {
                "M12,2C6.47,2 2,6.47 2,12C2,17.53 6.47,22 12,22A10,10 0 0,0 22,12C22,6.47 17.5,2 12,2M8.88,7.82L11,9.94L9.94,11L8.88,9.94L7.82,11L6.76,9.94L8.88,7.82M12,17.5C9.67,17.5 7.69,16.04 6.89,14H17.11C16.31,16.04 14.33,17.5 12,17.5M16.18,11L15.12,9.94L14.06,11L13,9.94L15.12,7.82L17.24,9.94L16.18,11Z"
            },
            "0 0 24 24");

        /// <summary>
        /// emoticon-excited-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonExcitedOutline = new SvgIconData(
            new string[] {
        ...
        /// emoticon-frown icon
        /// </summary>
        public static readonly SvgIconData EmoticonFrown = new SvgIconData(
            new string[] {
                "M12 2C6.47 2 2 6.5 2 12S6.47 22 12 22C17.5 22 22 17.5 22 12S17.5 2 12 2M15.5 8C16.33 8 17 8.67 17 9.5S16.33 11 15.5 11 14 10.33 14 9.5 14.67 8 15.5 8M8.5 8C9.33 8 10 8.67 10 9.5S9.33 11 8.5 11 7 10.33 7 9.5 7.67 8 8.5 8M6.89 17C7.69 14.96 9.67 13.5 12 13.5S16.31 14.96 17.11 17H6.89Z"
            },
            "0 0 24 24");

        /// <summary>
        /// emoticon-frown-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonFrownOutline = new SvgIconData(
            new string[] {
                "M12 2C6.47 2 2 6.5 2 12S6.47 22 12 22C17.5 22 22 17.5 22 12S17.5 2 12 2M12 20C7.58 20 4 16.42 4 12S7.58 4 12 4 20 7.58 20 12 16.42 20 12 20M15.5 11C16.33 11 17 10.33 17 9.5S16.33 8 15.5 8 14 8.67 14 9.5 14.67 11 15.5 11M8.5 11C9.33 11 10 10.33 10 9.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11M12 13.5C9.67 13.5 7.69 14.96 6.89 17H17.11C16.31 14.96 14.33 13.5 12 13.5Z"
            },
            "0 0 24 24");
        ...
        /// emoticon-happy icon
        /// </summary>
        public static readonly SvgIconData EmoticonHappy = new SvgIconData(
            new string[] {
        ...
        /// <summary>
        /// emoticon-happy-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonHappyOutline = new SvgIconData(
            new string[] {
        ...
        /// emoticon-kiss icon
        /// </summary>
        public static readonly SvgIconData EmoticonKiss = new SvgIconData(
            new string[] {
        ...
        /// <summary>
        /// emoticon-kiss-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonKissOutline = new SvgIconData(
            new string[] {
        ...
        /// emoticon-lol icon
        /// </summary>
        public static readonly SvgIconData EmoticonLol = new SvgIconData(
            new string[] {
                "M15.07 8.93V4.93A4.06 4.06 0 0 1 15.73 2.72A10 10 0 0 0 2.73 15.72A4.06 4.06 0 0 1 4.94 15.06H8.94V19.06A4.06 4.06 0 0 1 8.28 21.27A10 10 0 0 0 21.28 8.27A4.06 4.06 0 0 1 19.07 8.93M11 6H12.5V7.5H14V9H11M7.5 14V12.5H6V11H9V14M15.89 15.9A5.5 5.5 0 0 1 9.8 17L17 9.8A5.5 5.5 0 0 1 15.89 15.89M4.89 21.08A2 2 0 0 1 2.89 19.08A2 2 0 0 1 4.89 17.08H6.89V19.08A2 2 0 0 1 4.93 21.07M19.07 2.93A2 2 0 0 1 21.07 4.93A2 2 0 0 1 19.07 6.93H17.07V4.93A2 2 0 0 1 19.07 2.93Z"
            },
            "0 0 24 24");

        /// <summary>
        /// emoticon-lol-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonLolOutline = new SvgIconData(
            new string[] {
                "M6 11V12.5H7.5V14H9V11M12.5 6H11V9H14V7.5H12.5M9.8 17A5.5 5.5 0 0 0 17 9.8M6.34 6.34A8 8 0 0 1 15.08 4.62A4.11 4.11 0 0 1 15.73 2.72A10 10 0 0 0 2.73 15.72A4.11 4.11 0 0 1 4.63 15.07A8 8 0 0 1 6.34 6.34M17.66 17.66A8 8 0 0 1 8.92 19.38A4.11 4.11 0 0 1 8.27 21.28A10 10 0 0 0 21.27 8.28A4.11 4.11 0 0 1 19.37 8.93A8 8 0 0 1 17.66 17.66M6 11V12.5H7.5V14H9V11M9.8 17A5.5 5.5 0 0 0 17 9.8M12.5 6H11V9H14V7.5H12.5M6 11V12.5H7.5V14H9V11M12.5 6H11V9H14V7.5H12.5M9.8 17A5.5 5.5 0 0 0 17 9.8M4.93 21A2 2 0 0 1 2.93 19A2 2 0 0 1 4.93 17H6.93V19A2 2 0 0 1 4.93 21.07M19.07 2.93A2 2 0 0 1 21.07 4.93A2 2 0 0 1 19.07 6.93H17.07V4.93A2 2 0 0 1 19.07 2.93Z"
            },
            "0 0 24 24");

        /// <summary>
        /// emoticon-neutral icon
        /// </summary>
        public static readonly SvgIconData EmoticonNeutral = new SvgIconData(
            new string[] {
                "M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M7,9.5A1.5,1.5 0 0,1 8.5,8A1.5,1.5 0 0,1 10,9.5A1.5,1.5 0 0,1 8.5,11A1.5,1.5 0 0,1 7,9.5M16,16H8V14H16V16M15.5,11A1.5,1.5 0 0,1 14,9.5A1.5,1.5 0 0,1 15.5,8A1.5,1.5 0 0,1 17,9.5A1.5,1.5 0 0,1 15.5,11Z"
            },
            "0 0 24 24");

        /// <summary>
        /// emoticon-neutral-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonNeutralOutline = new SvgIconData(
            new string[] {
        ...
        /// </summary>
        public static readonly SvgIconData EmoticonOutline = new SvgIconData(
            new string[] {
        ...
        /// emoticon-poop icon
        /// </summary>
        public static readonly SvgIconData EmoticonPoop = new SvgIconData(
            new string[] {
        ...
        /// <summary>
        /// emoticon-poop-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonPoopOutline = new SvgIconData(
            new string[] {
        ...
        /// emoticon-sad icon
        /// </summary>
        public static readonly SvgIconData EmoticonSad = new SvgIconData(
            new string[] {
        ...
        /// <summary>
        /// emoticon-sad-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonSadOutline = new SvgIconData(
            new string[] {
        ...
        /// </summary>
        public static readonly SvgIconData EmoticonTongue = new SvgIconData(
            new string[] {
        ...
        /// emoticon-wink icon
        /// </summary>
        public static readonly SvgIconData EmoticonWink = new SvgIconData(
            new string[] {
        ...
        /// <summary>
        /// emoticon-wink-outline icon
        /// </summary>
        public static readonly SvgIconData EmoticonWinkOutline = new SvgIconData(
            new string[] {
                "M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20M10,9.5C10,10.3 9.3,11 8.5,11C7.7,11 7,10.3 7,9.5C7,8.7 7.7,8 8.5,8C9.3,8 10,8.7 10,9.5M12,17.23C10.25,17.23 8.71,16.5 7.81,15.42L9.23,14C9.68,14.72 10.75,15.23 12,15.23C13.25,15.23 14.32,14.72 14.77,14L16.19,15.42C15.29,16.5 13.75,17.23 12,17.23M17,10H13V9H17V10Z"
            },
            "0 0 24 24");
        ...
        /// sticker-emoji icon
        /// </summary>
        public static readonly SvgIconData StickerEmoji = new SvgIconData(
            new string[] {
                "M5.5,2C3.56,2 2,3.56 2,5.5V18.5C2,20.44 3.56,22 5.5,22H16L22,16V5.5C22,3.56 20.44,2 18.5,2H5.5M5.75,4H18.25A1.75,1.75 0 0,1 20,5.75V15H18.5C16.56,15 15,16.56 15,18.5V20H5.75A1.75,1.75 0 0,1 4,18.25V5.75A1.75,1.75 0 0,1 5.75,4M14.44,6.77C14.28,6.77 14.12,6.79 13.97,6.83C13.03,7.09 12.5,8.05 12.74,9C12.79,9.15 12.86,9.3 12.95,9.44L16.18,8.56C16.18,8.39 16.16,8.22 16.12,8.05C15.91,7.3 15.22,6.77 14.44,6.77M8.17,8.5C8,8.5 7.85,8.5 7.7,8.55C6.77,8.81 6.22,9.77 6.47,10.7C6.5,10.86 6.59,11 6.68,11.16L9.91,10.28C9.91,10.11 9.89,9.94 9.85,9.78C9.64,9 8.95,8.5 8.17,8.5M16.72,11.26L7.59,13.77C8.91,15.3 11,15.94 12.95,15.41C14.9,14.87 16.36,13.25 16.72,11.26Z"
            },
            "0 0 24 24");
