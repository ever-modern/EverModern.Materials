...
/// <summary>
/// LINQ-to-entities query surface with asynchronous materialization.
/// </summary>
/// <typeparam name="T">The element type.</typeparam>
public interface IAsyncOnlyQueryable<T> : IAsyncMaterializable<T>
{
    /// <summary>
    ...
    /// </summary>
    IAsyncOnlyOrderedQueryable<T> OrderBy<TKey>(Expression<Func<T, TKey>> keySelector);
    /// <summary>
    /// Orders elements by the specified key in descending order.
    /// </summary>
    IAsyncOnlyOrderedQueryable<T> OrderByDescending<TKey>(Expression<Func<T, TKey>> keySelector);
    /// <summary>
