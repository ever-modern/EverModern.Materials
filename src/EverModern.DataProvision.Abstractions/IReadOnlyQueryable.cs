...
/// <summary>
/// Read-only LINQ-to-entities query surface with synchronous materialization.
/// </summary>
/// <typeparam name="T">The element type.</typeparam>
public interface IReadOnlyQueryable<T> : ISyncMaterializable<T>
{
    /// <summary>
    ...
    /// </summary>
    IReadOnlyQueryable<TResult> GroupJoin<TInner, TKey, TResult>(
    ...
    /// </summary>
    IReadOnlyQueryable<TResult> LeftJoin<TInner, TKey, TResult>(
        IReadOnlyQueryable<TInner> inner,
        Expression<Func<T, TKey>> outerKeySelector,
        Expression<Func<TInner, TKey>> innerKeySelector,
    ...
    /// </summary>
    IReadOnlyOrderedQueryable<T> OrderBy<TKey>(Expression<Func<T, TKey>> keySelector);
    /// <summary>
    /// Orders elements by the specified key in descending order.
    /// </summary>
    IReadOnlyOrderedQueryable<T> OrderByDescending<TKey>(Expression<Func<T, TKey>> keySelector);
    /// <summary>
