...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine($"Initial state: '{new string(mask1.Slots)}'");
        ...
        Console.WriteLine($"Final state: '{new string(mask1.Slots)}'");
        Console.WriteLine($"Final number: {int.Parse(new string(mask1.Slots))}");
        ...
        Console.WriteLine($"Initial state: '{new string(mask2.Slots)}'");
        ...
        Console.WriteLine($"Final state: '{new string(mask2.Slots)}'");
        Console.WriteLine($"Final number: {int.Parse(new string(mask2.Slots))}");
